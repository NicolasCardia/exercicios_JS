...
let adicionaPessoa = document.getElementById( "adicionaPessoa" ); //controler
...
adicionaPessoa.addEventListener( "click", function()
{
    ...
    request.addEventListener( "load", function ()
    {
        ...
        console.log( `${request.status} (${request.statusText}): Dados recebidos` ); //view 
        ...
        //
        if ( request.status == 200 /*OK*/ ) //controler
        {
            ...
            for ( let pessoa of pessoas ) //view 
            {
